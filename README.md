...
**文件夹选择功能**：
- 选择一个文件夹（📁）确认后将包含文件夹内所有文件
- 支持递归选择：选择父文件夹会在确认后包含所有子文件夹及其文件
- 方便批量选择相关文件，无需逐个勾选
...
**使用技巧**：
- 💡 **批量选择模块**：选择 `src/` 文件夹可一次性选择整个 src 模块的所有文件
- 💡 **排除某个目录**：先全选，然后取消选择不需要的文件夹（如 `tests/`）
- 💡 **精细控制**：可以选择文件夹后，再取消选择其中个别不需要的文件
